...
app.post("/findSong", (req, res)=>{
    ...
    const params = {key: process.env.YTAPI_KEY, q: query, part: 'snippet', maxResults: 6};
...
app.get("/submit", (req, res) => {
        ...
        const firstSong = new songModel({'title': req.query.myName, 'album': req.query.album, 'duration': req.query.duration, 'videoId': req.query.videoId});
